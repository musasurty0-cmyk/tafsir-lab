...
const en: Dict = {
  ...
  "modal.nawawi":          "Forty Hadith",
  "modal.nawawiDesc":      "al-Arbaʿūn an-Nawawiyya — the forty-two, one at a time",
...
const ar: Dict = {
  ...
  "modal.nawawi":          "الأربعون النووية",
  "modal.nawawiDesc":      "دراسة الأربعين النووية حديثًا حديثًا",
