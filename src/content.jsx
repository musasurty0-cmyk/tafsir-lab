...
const COMMENTARY = {
  ...
  "Q 1:1–4": {
    ...
    sources: [
      {
        author: "Theological sequence",
        years: "Verses 1–4 · the praise section",
        initials: "§",
        body: (
          <>
            <p>
              The first four verses establish the theological foundation: Allah's name, His mercy (twice), His lordship over all worlds,
              and His ownership of the Day of Judgment. Al-Rāzī structures these as a progression from <i>essence</i> (the name) to
              <i>attributes</i> (mercy) to <i>relationship</i> (Lord of worlds) to <i>eschatology</i> (Day of Judgment).
            </p>
          </>
        ),
      },
